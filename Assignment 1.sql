...
-- b) add couple of countries of your choice
insert into countries (name ,population,capital)
values('Spain',56,'Madrid'),
('South Korea', 51, 'Seoul' ),
( 'Colombia', 50,'Bogota' )
;

-- c) Chamge delhi to New delhi.
...
-- 6) Enter some records in three tables.
INSERT INTO product ( product_name, description, supplier_id )
			 VALUES ('Mobile', 'A mobile phone, portable device for connecting to a telecommunications network in order to transmit and receive voice, etc.',Null ),
...
update product set supplier_id=case product_name
